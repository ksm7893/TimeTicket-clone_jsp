...
public class ListDTO {
	...
	//constructor
	public ListDTO(String tic_code, String tic_name, String tic_prof, String reg_code, String lcate_code,
			String lcate_name, String scate_code, String scate_name, String gen_code, String gen_name, int tic_price,
			String tic_loc, Date tic_regist,int newb, int tic_kids, int msale, String stic_price, double ravg, int rcount,
	...
	public ListDTO(String lcate_name) {
		super();
		this.lcate_code = lcate_name;
	}
	//getter/setter
