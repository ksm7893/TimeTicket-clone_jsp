...
public class MainTicDTO {
	...
	public MainTicDTO(String tic_code, String tic_name, String tic_prof, String reg_code, String lcate_code,
			String lcate_name, String scate_code, String scate_name, String gen_code, String gen_name, int tic_price,
			String tic_loc, Date tic_regist, int newb, int tic_kids, int msale, int stic_price, double ravg, int rcount,
			String tgwon_name, String dgwon_name, int sticket) {
		super();
	...
	public int getStic_price() {
		return stic_price;
	}

	public void setStic_price(int stic_price) {
		this.stic_price = stic_price;
	}
